...
public class Balloon {
     ...
     * The simulation starts with the given air temperature and wind direction.
     * 
     * @param airTemp the outside air temperature in degrees Celsius.
     * @param windDirection the wind direction in degrees. It is assumed to be between 0 (inclusive) and 360 (exclusive).
     */
	...
	/**
	 * Gives the remaining amount of fuel that can be used to heat the air in the balloon.
	 * 
	...
	public void setFuelRemaining(double fuel){
